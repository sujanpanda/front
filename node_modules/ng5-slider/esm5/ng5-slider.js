...
import { Renderer2, ElementRef, Component, Directive, ViewChild, HostBinding, HostListener, Input, EventEmitter, Output, ContentChild, ChangeDetectorRef, forwardRef, NgModule } from '@angular/core';
...
var JqLiteWrapper = /** @class */ (function () {
    ...
    JqLiteWrapper.prototype.on = function (eventName, callback, debounceInterval) {
    ...
    JqLiteWrapper.prototype.onPassive = function (eventName, callback, debounceInterval) {
...
var SliderComponent = /** @class */ (function () {
    ...
    SliderComponent.prototype.roundStep = function (value, customStep) {
        var step = customStep ? customStep : this.viewOptions.step;
    ...
    SliderComponent.prototype.valueToPosition = function (val) {
        ...
        var percent = fn(val, this.viewOptions.floor, this.viewOptions.ceil) || 0;
        if (this.viewOptions.rightToLeft) {
            percent = 1 - percent;
        }
    ...
    SliderComponent.prototype.bindEvents = function () {
        ...
        if (this.viewOptions.draggableRangeOnly) {
            ...
            if (!this.viewOptions.onlyBindHandles) {
                this.fullBarElem.on('mousedown', function (event) { return _this.onStart(null, null, event, true, true, true); });
                this.ticksElem.on('mousedown', function (event) { return _this.onStart(null, null, event, true, true, true, true); });
            }
        }
        if (!this.viewOptions.onlyBindHandles) {
    ...
    SliderComponent.prototype.onStart = function (pointer, ref, event, bindMove, bindEnd, simulateImmediateMove, simulateImmediateEnd) {
        ...
        if (bindMove) {
            this.unsubscribeOnMove();
            var onMoveCallback = function (e) { return _this.dragging.active ? _this.onDragMove(pointer, e) : _this.onMove(pointer, e); };
    ...
    SliderComponent.prototype.onMove = function (pointer, event, fromTick) {
        ...
        var flrValue = this.viewOptions.rightToLeft ? this.viewOptions.ceil : this.viewOptions.floor;
        if (newPos <= 0) {
            newValue = flrValue;
        }
    ...
    SliderComponent.prototype.onDragStart = function (pointer, ref, event, bindMove, bindEnd) {
        var position = this.getEventPosition(event);
        this.dragging = new Dragging();
