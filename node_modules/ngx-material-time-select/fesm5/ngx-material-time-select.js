 ...
 */
/** @type {?} */
var MAT_TIME_FORMATS = new InjectionToken('mat-time-formats');
...
/** @type {?} */
var _MatTimeUnitOptionMixinBase = mixinDisableRipple(MatTimeUnitOptionBase);
/**
 ...
 * @type {?}
 */
var MAT_TIME_SELECT_DATA = new InjectionToken('mat-time-select-data');
/**
 * Injection token that determines the scroll handling while the time select is opened.
 * @type {?}
 */
var MAT_TIME_SELECT_SCROLL_STRATEGY = new InjectionToken('mat-time-select-scroll-strategy');
/**
 * \@docs-private
 * @param {?} overlay
 * @return {?}
...
/** @type {?} */
var _MatTimeSelectContentMixinBase = mixinColor(MatTimeSelectContentBase);
/**
