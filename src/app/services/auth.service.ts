...
export class AuthService {
  private _registerUrl = "http://139.59.35.15:3000/api/register";
  private _loginUrl = "http://139.59.35.15:3000/api/login";
  constructor(
	...
	getTokenWeb() {
	    return this.http.get('http://139.59.35.15:3000/api/tokengetting', {
	      observe: 'body',
